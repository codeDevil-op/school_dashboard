...
<div className="relative overflow-x-auto shadow-md sm:rounded-lg">
    <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
        ...
        <tbody>
            {allStudents.map((stu)=>{
                ...
                return(
                    <tr className="bg-white border-t hover:bg-gray-50 p-4" key={stu.id}>
                ...
                <td className="px-5 py-4 text-[#303972] font-semibold flex items-center">
                <Image src={stu.img} alt="" className='w-10 h-10 rounded-full'/>
                    <div className="ps-3">
                        <div className="text-base font-semibold">{stu.name}</div>
                    </div>  
                </td>
                <td className="px-5 py-4 text-[#303972] font-semibold">
                #{stu.ide}
                </td>
                <td className="px-5 py-4 text-[#A098AE]">
                {stu.mdy}
                </td>
                <td className="px-5 py-4 text-sm text-[#303972]">
                {stu.fName}
                </td>
                <td className="px-5 py-4 text-sm text-[#303972]">
                {stu.city}
                </td>
                <td className="px-5 py-4 text-sm text-[#303972] flex justify-between">
                ...
                <td className="px-5 py-4 text-sm text-[#303972]">
                    <div className='w-12 h-8 bg-[#FB7D5B] rounded-full flex justify-center items-center text-white'>
                        <h1>{stu.grade}</h1>
                    </div>
                </td>
                <td className="px-5 py-4 text-xl text-[#A098AE] font-bold ">
                    ...
                </td>
            </tr>
                )
    ...
    <div className='flex flex-col space-y-4 md:space-y-0 md:flex-row justify-between items-center text-[#363B64] text-sm font-normal bg-white p-4'>
